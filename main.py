...
MARKETING_MESSAGES = {
    ...
    "divulgacao": (
        ...
        "✅ **Sinais Gratuitos Todos os Dias**\n✅ **Análises Precisas e em Tempo Real**\n✅ **Comunidade com Milhares de Membros Lucrando**\n✅ **Gale 1 e 2 Níveis com Gestão de Banca (4%, 8% ou 16%)**\n✅ **Cupom Exclusivo 'GESTÃO' para benefícios extras!**\n\n"
        "Chega de contar com a sorte. Comece a lucrar com estratégia!\n\n"
        "👇 **ENTRE AGORA NO NOSSO GRUPO, FAÇA SEU DEPÓSITO E COMECE A LUCRAR HOJE MESMO!** 👇\n"
        f"🔗 {URL_CADASTRO_DEPOSITO}\n"
    ),
    "oferta_maluca": (
        "🚨 **OFERTA MALUCA LIBERADA!** 🚨\n\n"
        "Galera, acabei de receber a permissão para os **primeiros 20 novos depósitos**!\n\n"
        "Você vai ganhar:\n"
        "💰 **Bônus de R$600** no seu primeiro depósito!\n"
        "🎰 **Mais Giros** grátis em jogos selecionados!\n"
        "🎁 Participação em **Sorteios Exclusivos** para membros VIP!\n\n"
        "Não perca essa chance única! Clique no link abaixo, faça seu depósito e me envie o print no privado para liberar seu acesso IMEDIATAMENTE!\n\n"
        f"➡️ [**CLIQUE AQUI PARA GARANTIR SUA OFERTA!**]({URL_CADASTRO_DEPOSITO})"
    ),rta_maluca": (
        "🚨 **OFERTA MALUCA LIBERADA!** 🚨\n\n"
        "Galera, acabei de receber a permissão para os **primeiros 20 novos depósitos**!\n\n"
        "Você vai ganhar:\n"
    ...
    "oferta_cupom_gestao": (
        "🎁 **PRESENTE PARA VOCÊ! Use o Cupom GESTÃO!** 🎁\n\n"
        "Quer turbinar seus ganhos e ter uma gestão de banca impecável? Use nosso cupom exclusivo!\n\n"
        "**CUPOM:** `GESTÃO`\n\n"
        "**O que você ganha com o cupom GESTÃO?**\n"
        "✅ Bônus Extra no seu depósito!\n"
        "✅ Vantagens VIP exclusivas!\n"
        "✅ Fácil de usar no seu cadastro!\n\n"
        "**E TEM MAIS! Participe do nosso Torneio VIP Exclusivo!**\n\n"
        "Não é só para herdeiros — mas também para participantes do torneio VIP! Olha o que os jogadores ganharam da última vez:\n"
        ...
        "💻 MacBook Pro 16\"\n"
        "📱 iPhone 16 Pro Max\n\n"
        "**Gostaria de ganhar o mesmo?**\n"
        f"Toque no botão abaixo e entre para o clube privado. O jogo pelos prêmios mais desejados começa aqui!\n"
        f"➡️ [**ENTRAR NO CLUBE PRIVADO VIP**]({URL_CADASTRO_DEPOSITO})\n\n"
        "Use o cupom `GESTÃO` no seu cadastro e garanta benefícios extras!\n"
    ),
    "boas_vindas_start": (
...
async def enviar_sinal_especifico(context: ContextTypes.DEFAULT_TYPE, jogo: str, aposta: str, target_id: int):
    ...
    try:
        ...
        resultado = random.choices(
            ["win_primeira", "win_gale1", "win_gale2", "loss"], weights=probabilidades, k=1
        )[0]
...
async def send_marketing_message(context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if message_type == "divulgacao" or message_type == "oferta_cupom_gestao":
            await context.bot.send_message(
                chat_id=FREE_CANAL_ID,
                text=message_text,
                parse_mode=ParseMode.MARKDOWN,
...
# ID do Admin
ADMIN_ID=5011424031[2/9 17:40] ...: # -*- coding: utf-8 -*-
# ===================================================================================
# BOT DE SINAIS - VERSÃO 24.2 "MÁQUINA DE CONVERSÃO" (CORRIGIDO E ROBUSTO)
# CRIADO E APRIMORADO POR MANUS
# - Funil de boas-vindas automático e pessoal para cada novo membro.
